# Project Memory — automation-architects

This file loads automatically when Claude Code runs in this project.
...
## Tech Stack
Dependencies: @radix-ui/react-slot, class-variance-authority, clsx, framer-motion, lucide-react, next, next-mdx-remote, radix-ui, react, react-dom

## Key Rules for This Project
- Read `tasks/todo.md` at session start — know what's in progress
- Read `tasks/lessons.md` at session start — never repeat past mistakes
- Write specs to `specs/` before implementing any non-trivial feature
- Update `tasks/todo.md` as you work

## Contacts & Context
- Owner: Chris (chrismrgn)
- Repo: github.com/chrismrgn/automation-architects
- Local path: /home/jeffbot/projects/automation-architects
